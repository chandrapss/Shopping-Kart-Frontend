...
import logo from '../picture/Ajio.png';

const MerchantNavbar = () => {

    let [sub, setsub]=useState(false)
    return (
      <div className='navbarmerchant'>
        <div className='navmerchant'>
          <div className='logomerchant'>
              <img src={logo} alt="" />
          </div>
          <div className="optionsmerchant">
              <div className="wishm">
                  <Link to="viewproduct"><h3>View Product</h3></Link>
              </div>
              <div className="addm">
              <Link to='additems'><h3>Add Item</h3></Link>
              </div>
              <div className="searchmerchant">
                    <input placeholder='search' type="text" />
                  <button className='btn'>Search</button> 
              </div>
              <div onClick={()=>{setsub(!sub)}} className="profilemerchant">
                  ...
                  {sub && 
                  <div className="sub1merchant">
                   <Link to="" id='11'>Edit Profile</Link>
                   <Link to="" id='11'>Check Order</Link>
                   <Link to="" id='11'>Update Address</Link>
                   <Link to="" id='11'>Logout</Link>
                  </div> }
              </div>
          </div>
